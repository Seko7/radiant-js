...
export  function Navbar() {
  ...
  return (
    <header className="z-50 relative isolate  bg-none">
      <nav aria-label="Global" className="mx-auto flex w-screen max-w-[150rem] items-center justify-between p-6 lg:px-8">
