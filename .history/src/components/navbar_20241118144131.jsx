...
export function Navbar() {
  ...
  return (
    <div>
      ...
      <header className="fixed top-0 w-full bg-white/60 backdrop-blur-lg isolate z-50 bg-none">
      <nav
        aria-label="Global"
      ...
      >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12 ">
          <Popover>
            ...
            <PopoverPanel
              transition
              className="absolute inset-x-0 top-0 -z-10 w-full bg-white-600/50 pt-16 shadow-lg ring-1 ring-gray-900/5 transition data-[closed]:-translate-y-1 data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in"
            >
              <div className="bg-green mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-6 py-10 lg:grid-cols-2 lg:px-8">
              ...
              <div className='absolute h-96 w-full bg-red-600/50'></div>
            </PopoverPanel>
          </Popover>
