      ...
      >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12 ">
          <Popover>
            ...
            <PopoverPanel
              transition
              className="absolute inset-x-0 top-0 -z-10 w-full bg-white pt-16 shadow-lg ring-1 ring-gray-900/5 transition data-[closed]:-translate-y-1 data-[closed]:opacity-0 data-[closed]:h-0 data-[enter]:duration-200 data-[enter]:h-auto data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in"
            >
              ...
              {/* <div className='absolute h-96 w-full bg-gray-300/60 backdrop-blur-xl   max-sm:hidden'></div> */}
            </PopoverPanel>
          </Popover>
      ...
      >
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="/" className="-m-1.5 p-1.5 md:opacity-0 sm:opacity-0">
              <span className="sr-only">Suyabakan</span>
