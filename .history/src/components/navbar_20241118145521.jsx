      ...
      >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12 ">
          <Popover>
            ...
            >
              <div className="bg-green-500 w-screen mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-6 py-10 lg:grid-cols-2 lg:px-8">
            ...
            <div className='absolute h-screen w-full -bottom-[40rem] bg-white/50 backdrop-blur-xl   max-sm:hidden'></div>
