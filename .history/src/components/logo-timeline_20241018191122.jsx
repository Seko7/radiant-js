  ...
  return (
    <div aria-hidden="true" className="relative h-full overflow-hidden">
      <div className="absolute inset-0 top-8 z-10 flex items-center justify-center">
        ...
        />
        <div className="relative flex size-40 items-center justify-center rounded-xl bg-gradient-to-t from-white/5 to-white/25 shadow outline outline-offset-[-15px] outline-white/5 ring-1 ring-inset ring-white/10">
        <img
