...
export  function Navbar() {
  ...
  return (
    <header className="z-50 w-screen -ml-32 relative isolate  bg-red-600">
      <nav aria-label="Global" className="mx-auto flex max-w-none items-center justify-between p-6 lg:px-8">
