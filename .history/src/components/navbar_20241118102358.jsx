      ...
      >
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            /> */}
            <div className=' scale-[80%] ml-8 mt-4'>
            <Logo />
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Popover>
            ...
            <PopoverPanel
              transition
              className="absolute inset-x-0 top-0 w-screen -z-10 bg-red-300 pt-16 shadow-lg ring-1 ring-gray-900/5 transition data-[closed]:-translate-y-1 data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in"
            >
