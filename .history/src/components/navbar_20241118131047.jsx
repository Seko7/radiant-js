...
export function Navbar() {
  ...
  return (
    <div>
      <div className='h-20 w-full max-sm:hidden'></div>
      <header className="lg:fixed lg:top-0 lg:w-full lg:bg-white/60 lg:backdrop-blur-lg isolate z-50 bg-none">
      <nav
        aria-label="Global"
      ...
      >
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            /> */}
            <div className="ml-8 mt-4 scale-[80%] max-sm:ml-2 max-sm:mt-2 max-sm:scale-100">
              <Logo />
            </div>
          </a>
        </div>
