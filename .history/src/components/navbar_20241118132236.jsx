      ...
      >
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="/" className="-m-1.5 p-1.5">
              <span className="sr-only">Suyabakan</span>
              <div className="ml- mt-4 scale-[80%] max-sm:ml-3 max-sm:mt-2 max-sm:scale-100">
                <Logo />
              </div>
            </a>
            <button
                  ...
                  <DisclosurePanel className="mt-2 space-y-2">
                    {[...products].map((item) => (
                      <DisclosureButton
                        ...
                        as="a"
                        href={item.href}
                        className="block rounded-lg py-2 pl-6 pr-3 text-slg/3 font-semibold text-gray-900 hover:bg-gray-50"
                      >
                        {item.name}
                      </DisclosureButton>
                    ))}
