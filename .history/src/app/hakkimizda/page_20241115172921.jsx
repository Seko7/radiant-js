...
const values = [
  {
    name: 'Yüksek kalite standartları',
    description:
      'Ürün ve hizmetlerimizde kaliteyi en üst düzeyde tutuyoruz. Çiftçilerimizin ihtiyaçlarını anlıyor ve en iyisini sunmak için sürekli gelişiyoruz.',
  },
  {
    name: 'Bilgiyi paylaşma',
    description:
      'Suyabakan ekibi olarak sahip olduğumuz bilgi ve deneyimi çiftçilerimizle paylaşıyoruz. Bilgi paylaşımının gücüne inanıyor ve topluluklarımızı eğiterek güçlendiriyoruz.',
  },
  {
    name: 'Sürekli öğrenme',
    description:
      'Teknolojinin hızla ilerlediği bir dünyada, her zaman öğrenmeye açık ve gelişime odaklıyız. Tarım teknolojilerinde en son yenilikleri takip ederek çiftçilerimize daha iyi çözümler sunuyoruz.',
  },
  {
    name: 'Destekleyici yaklaşım',
    description:
      'Müşterilerimizi iş ortaklarımız olarak görüyor, ihtiyaç duydukları her an destek veriyoruz. İyi bir iş birliği için güçlü bir iletişim kurarak çiftçilerimizin yanında olmaktan mutluluk duyuyoruz.',
  },
  {
    name: 'Sorumluluk alma',
    description:
      'Suyabakan olarak tarımsal süreçlerin her aşamasında sorumluluk alıyoruz. Ürünlerimizin güvenilirliği ve çevre dostu yapısı ile sürdürülebilir bir tarımın mümkün olduğuna inanıyoruz.',
  },
  {
    name: 'Yenilikçi olma',
    description:
      'Sorunları çözerken yenilikçi yöntemler üretmekten keyif alıyoruz. Ekip olarak enerjik ve motive bir şekilde çiftçilerimizin ihtiyaçlarını karşılamak için çalışıyoruz.',
  },
]
const team = [
  {
  ...
  return(<main className="isolate">
    ...
    <div className="relative isolate -z-10">
      ...
      <div className="overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 pb-32 pt-3 sm:pt-60 lg:px-8 lg:pt-4">
          <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
              <h1 className="text-pretty text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
                Tarıma yeni bakış açısı sunuyoruz.
              </h1>
              <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">
              Suyabakan olarak tarım teknolojileri alanında insanları toprağa daha akıllı bir şekilde bağlayarak tarımsal verimliliği artırıyoruz. Akıllı sulama, iklim izleme, toprak ve su yönetimi gibi çözümlerimizle tarım süreçlerini daha sürdürülebilir, verimli ve kolay hale getiriyoruz. Çiftçilerin ihtiyaçlarına duyarlı, yenilikçi ve kullanıcı dostu sistemlerimizle modern tarımın öncüsüyüz.
              </p>
            </div>
    ...
    <div className="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
      <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
        <h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Misyonumuz</h2>
        <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
          <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
            <p className="text-xl/8 text-gray-600">
            Tarımsal verimliliği artırmak ve sürdürülebilir çözümler sunmak adına teknoloji ile toprağı buluşturuyoruz.
            </p>
            <p className="mt-10 max-w-xl text-base/7 text-gray-700">
            Çiftçilerimizin toprağa ve çevresel verilere dayalı, bilimsel verilere dayalı kararlar almasını sağlayarak hem tarımsal verimi artırmayı hem de çevre dostu bir tarım yapılmasını amaçlıyoruz. Misyonumuz, tarımı daha akıllı hale getirerek geleceğe daha sağlıklı bir dünya bırakmak.
            </p>
          </div>
    ...
    <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
      <div className="mx-auto max-w-2xl lg:mx-0">
        <h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Vizyonumuz</h2>
        <p className="mt-6 text-lg/8 text-gray-600">
        Suyabakan olarak, tarım sektöründe sürdürülebilirlik ve verimlilik odaklı bir dünya yaratmayı hedefliyoruz. Akıllı tarım teknolojileriyle çiftçilere güç katarak toprağa değer katmak, çevre dostu çözümlerle tarımın geleceğini yeniden tanımlamak vizyonumuzun temelini oluşturuyor.
        </p>
      </div>
    ...
    <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-48 lg:px-8">
      <div className="mx-auto max-w-2xl lg:mx-0">
        <h2 className="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Suyabakan Ekibi</h2>
        <p className="mt-6 text-lg/8 text-gray-600">
        Suyabakan ekibi, tarım teknolojilerine tutkuyla bağlı, yenilikçi bir grup profesyonelden oluşmaktadır. Çiftçilerimizin ihtiyaçlarına en iyi şekilde yanıt verebilmek için sürekli gelişiyoruz ve tarım sektörünün en verimli çözümlerini sunma konusunda kararlıyız.
        </p>
      </div>
      <ul
        role="list"
