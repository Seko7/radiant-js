...
const values = [
  ...
  {
    name: 'Dinlenmeye değer verme',
    description:
      'Çalışmanın yanında dinlenmenin ve yenilenmenin de önemine inanıyoruz. Ekip olarak enerjik ve motive bir şekilde çiftçilerimizin ihtiyaçlarını karşılamak için çalışıyoruz.',
  },
]
const team = [
  {
