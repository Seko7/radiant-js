  ...
  return (
    <div className="relative">
      ...
      <Container className="relative">
        ...
        <div className="flex relative flex-row pb-24 pt-16 sm:pb-32 sm:pt-24 md:pb-[24rem] md:pt-28">
          ...
          <img
            ...
            className="absolute -z-10 rounded-4xl  -ml-[7rem] top-[-3rem] max-w-[118%]"
          />
        </div>
      </Container>
    </div>
