      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-ml-12 -mt-28 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            ...
            className="mx-auto w-[27rem] max-w-none rounded-xl sm:w-[35rem]"
          />
        </div>
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              <p>
                Suyabakan Assistant, tarımsal IoT cihazlarınızı yönetmek ve
                verimliliğinizi artırmak için tasarlanmış güçlü bir yazılımdır.
                Cihaz kontrolü, veri görüntüleme, geçmiş verilerin izlenmesi ve
                alarm oluşturma gibi işlevlerle donatılmış bu yazılım, yapay
                zeka ve makine öğrenmesi ile analizler yaparak tarımsal karar
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    Tüm Suyabakan IoT cihazlarınızı kolayca kontrol edin.{' '}
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <CheckCircleIcon
                  ...
                  <span>
                    ...
                    Topladığınız verileri anlık olarak görüntüleyin. Hava
                    durumu, toprak nemi, su seviyeleri ve basınçları gibi kritik
                    bilgileri kolayca erişin.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <CheckCircleIcon
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">
                      Geçmiş Verilerin İzlenmesi.
                    </strong>
                    Geçmişe dönük veri izleme özellikleri sayesinde tarımsal
                    trendleri analiz edin. Bu sayede geçmiş verilerle
                    gelecekteki kararlarınızı şekillendirin.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <CheckCircleIcon
                  ...
                  <span>
                    ...
                    Riskli durumlar için alarmlar oluşturun. Su seviyelerindeki
                    düşüş veya aşırı sıcaklık gibi durumlarda anında bildirim
                    alın.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">
                      Harita Bazlı Çiftlik Yönetimi.
                    </strong>{' '}
                    Çiftliğinizi harita üzerinde konumlandırın ve cihazlarınızı
                    bölgeye göre yönetin.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <CheckCircleIcon
                  ...
                  <span>
                    ...
                    Çiftlik alanınızı uydu görüntüleri ile gözlemleyerek
                    analizlerinizi genişletin.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <CheckCircleIcon
                  ...
                  <span>
                    ...
                    Yapay zeka ve makine öğrenmesi tabanlı analizlerle tarımsal
                    faaliyetlerinizi destekleyin; verimliliği artıracak daha iyi
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    Kullanıcı dostu bir arayüz ile işlemlerinizi hızla
                    gerçekleştirin, yazılımı kolayca öğrenin ve etkili bir
                    şekilde kullanın.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    Tüm verilerinize anlık olarak erişin ve hızlı kararlar
                    alarak tarımsal faaliyetlerinizi güvenle yönetin.
                  </span>
                </li>
              </ul>
              {/* <p className="mt-8">
              ...
              <div className="flex flex-row max-sm:flex-col">
                <button
                  onClick={() =>
                    window.open(
                      'https://play.google.com/store/apps/details?id=com.seko7.asistan&hl=tr',
                      '_blank',
                    )
                  }
                  className="mr-4 mt-8 inline-flex items-center justify-center rounded-lg bg-indigo-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  <div className="mr-2 flex items-center justify-center text-center text-4xl">
                ...
                <button
                  onClick={() =>
                    window.open(
                      'https://apps.apple.com/tr/app/suyabakan/id6736740769',
                      '_blank',
                    )
                  }
                  className="mr-4 mt-8 inline-flex items-center justify-center rounded-lg bg-indigo-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                ...
                <button
                  onClick={() =>
                    window.open('https://app.suyabakan.com', '_blank')
                  }
                  className="mr-4 mt-8 inline-flex items-center justify-center rounded-lg bg-indigo-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  <div className="mr-2 flex items-center justify-center text-center text-4xl">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="relative mt-16 h-[36rem] sm:h-auto sm:w-[calc(theme(maxWidth.7xl)-theme(spacing.16))]">
          ...
          <img
            ...
            className="h-full rounded-xl max-sm:object-cover max-sm:object-right shadow-2xl ring-1 ring-black/10"
          />
        </div>
      </div>
    </div>
    ...
    <div className="overflow-hidden bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="flex w-full items-center justify-center lg:ml-auto lg:pl-4 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg/8 text-gray-600">
                Çiftliğini, tarım alanlarını tek bir yerden yönet. Parsellerini
                belirle, takip et ve aksiyon al.
              </p>
            </div>
          </div>
          <div className="flex w-full items-end justify-center lg:order-first">
            <img
              ...
              width={1170}
              height={2532}
              className="w-[45rem] max-sm:w-64 max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[20rem]"
            />
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="flex w-full items-center justify-center lg:ml-auto lg:pl-4 lg:pt-4">
            <div className="lg:max-w-lg">
              <h2 className="text-base/7 font-semibold text-indigo-600">
                Kontrolcülere erişim
              </h2>
              <p className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
                Tek tuşla sulama
              </p>
              <p className="mt-6 text-lg/8 text-gray-600">
                Akıllı vana ve pompalarla etkileşime geçilebilir. Tek tuşla
                sulama yap, sulama planla veya deponu doldur.
              </p>
            </div>
          </div>
          <div className="flex w-full items-end justify-center">
            <img
              ...
              width={1170}
              height={2532}
              className="w-[45rem] max-sm:w-64 max-w-none rounded-xl sm:w-[24rem]"
            />
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="flex w-full items-center justify-center lg:ml-auto lg:pl-4 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg/8 text-gray-600">
                Sensör verilerine anında erişim sağla. Toprak nemini,
                sıcaklığını, hava durumunu ve daha fazlasını takip et. Geçmişe
                dönük verileri incele ve geleceğe dair kararlar al.
              </p>
            </div>
          </div>
          <div className="flex w-full items-end justify-center lg:order-first">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="flex w-full items-center justify-center lg:ml-auto lg:pl-4 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg/8 text-gray-600">
                Çiftlik alanınızı harita bazlı takip sistemi ve uydu görüntüleri ile gözlemleyerek analizlerinizi genişletin.
              </p>
            </div>
          </div>
          <div className="flex w-full items-end justify-center">
            <img
              alt="Product screenshot"
              src="/screenshots/appuydu.png"
              width={1170}
              height={2532}
              className="w-[42rem] max-sm:w-64 max-w-none rounded-xl sm:w-[20rem]"
            />
          </div>
        </div>
      </div>
...
export default function Ürünler({ searchParams }) {
  ...
  return (
    <main className="relative overflow-hidden lg:overflow-visible">
      ...
      <Asistan5 />
      <Asistan6 />
      <div className=" w-full justify-center flex flex-row max-sm:flex-col max-sm:mx-2">
        <button
          onClick={() =>
            window.open(
              'https://play.google.com/store/apps/details?id=com.seko7.asistan&hl=tr',
        ...
        <button
          onClick={() => window.open('https://app.suyabakan.com', '_blank')}
          className="mr-4 mt-8 inline-flex items-center justify-center rounded-lg bg-indigo-600 px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        >
          <div className="mr-2 flex items-center justify-center text-center text-4xl">
            <ion-icon name="globe-outline"></ion-icon>{' '}
