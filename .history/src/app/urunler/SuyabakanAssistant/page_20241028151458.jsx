            ...
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">Cihaz Kontrolü.</strong> Suyabakan Air Sense, rüzgar hızını yüksek hassasiyetle ölçer. Bu veri, tarımsal uygulamalarınızda rüzgar etkilerini gözlemlemenizi sağlar.
                  </span>
                </li>
                <li className="flex gap-x-3">
