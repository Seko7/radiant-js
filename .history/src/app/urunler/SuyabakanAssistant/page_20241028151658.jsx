            ...
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">Veri Görüntüleme.</strong> Topladığınız verileri anlık olarak görüntüleyin. Hava durumu, toprak nemi, su seviyeleri gibi kritik bilgileri kolayca erişin.</span>
                </li>
                <li className="flex gap-x-3">
