...
function Asistan3() {
  return (
    <div className="overflow-hidden bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto bg-blue-500 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="w-full items-center justify-center flex lg:ml-auto lg:pl-4 lg:pt-4 bg-red-300">
            <div className="lg:max-w-lg">
          ...
          <div className="flex w-fit items-start justify-start lg:order-first ">
            <img
