            ...
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">Cihaz Kontrolü.</strong> Tüm Suyabakan IoT cihazlarınızı kolayca kontrol edin. Yazılım, cihazlarınızın çalışma durumunu takip etmenize ve uzaktan yönetmenize olanak tanır. </span>
                </li>
                <li className="flex gap-x-3">
                ...
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Çiftlik Kurulumu ve Yönetimi.</strong> Çiftlik alanınızı kurun ve yönetin. Yazılım, tarımsal süreçlerinizi optimize etmek için kullanışlı araçlar sunar.</span>
                </li>
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Uydu Görütüsü.</strong> Çiftlik alanınızı kurun ve yönetin. Yazılım, tarımsal süreçlerinizi optimize etmek için kullanışlı araçlar sunar.</span>
                </li>
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Karar Destek Sistemleri.</strong> Yapay zeka ve makine öğrenmesi ile desteklenen analizler, tarımsal karar süreçlerinizi güçlendirir. Daha iyi kararlar almak için verilerinizi derinlemesine analiz edin.</span>
                </li>
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Kullanıcı Dostu Arayüz.</strong> Kablosuz bağlantı ile hızlı ve kolay kurulum imkanı sağlar. Herhangi bir kablo karmaşasına gerek kalmadan anında veri toplar.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Gerçek Zamanlı.</strong> Zorlu hava koşullarına dayanıklı yapısı ile uzun ömürlü kullanım sunar. Tarımsal ortamda güvenilir performans sağlar.
                  </span>
                </li>
