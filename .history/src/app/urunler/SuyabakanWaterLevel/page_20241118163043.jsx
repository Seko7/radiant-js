      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-lg/8 text-gray-600">
            Depo yüksekliğine göre belirlenen Suyabakan Water Level deponuzun su seviyesini mekanik parkça içermeden anlık olarak takip eder ve sulama işlemlerinizde size yardımcı olur.
          </p>
        </div>
      </div>
      <div className="relative overflow-hidden pt-16">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-gray-50  to-5% group-data-[dark]:from-gray-800 group-data-[dark]:from-[-25%]" />
          <img
            ...
            width={662}
            height={2042}
            className="mx-[27%] max-sm:mx-0 rounded-xl"
          />
        </div>
      </div>
      <BentoGrid />
