      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-lg/8 text-gray-600">
            Depo yapınız değiştiğinde, Suyabakan Water Level değişir. Depo boyunuzua göre belirlenen Suyabakan Water Level deponuzun su seviyesini anlık olarak takip eder ve sulama işlemlerinizde size yardımcı olur.
          </p>
        </div>
      </div>
