        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              <p className="text-base font-semibold leading-7 text-indigo-600">Akıllı Vana</p>
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              <p>
              Suyabakan Water Smart Valve, akıllı vana kontrolcüsü ve sensörleri ile donatılmış, tarımsal sulama işlemlerini kolayca yönetmenizi sağlar. Web veya mobil uygulama üzerinden uzaktan vana kontrolü yapabilir, sulama planları oluşturabilir veya sulama takvimi girebilirsiniz.
              </p>
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  <DevicePhoneMobileIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Uzaktan Kontrol.</strong> Water Smart Valve, web ve mobil uygulama üzerinden vananızı uzaktan açıp kapatmanızı sağlar. Bu özellik, sulama işlemlerinizi daha esnek hale getirir.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <CalendarIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Sulama Planlama.</strong> Hedeflerinize uygun olarak sulama planları oluşturun ve sulama takvimi girin. Böylece bitkilerinizin ihtiyaç duyduğu suyu zamanında almasını sağlayabilirsiniz.
                  </span>
                </li>
                <li className="flex gap-x-3">
<p aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-xl text-indigo-600">
    <ionic-icon name="thermometer-outline" ></ionic-icon>
</p>
                  <span>
                    <strong className="font-semibold text-gray-900">Basınç İzleme.</strong> Vana girişinde ve çıkışında bulunan sensörler, sulama sisteminizin verimliliğini artırmak için basınç kayıplarını izler. Bu sayede sorunları önceden tespit edebilirsiniz.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Su Akış Ölçümü.</strong> Su akış sayacı ile ne kadar su kullandığınızı takip edin. Bu özellik, su kaynaklarınızı verimli bir şekilde yönetmenizi sağlar.
                  </span>
                </li>
                <li className="flex gap-x-3">
                ...
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Kolay kurulum.</strong> Hızlı ve pratik kurulumu sayesinde Water Smart Valve’i tarla ortamınıza kolayca entegre edin ve hemen kullanmaya başlayın.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
