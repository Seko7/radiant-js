    ...
    <div className="relative isolate overflow-hidden px-6 py-24 max-lg:py-12 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-ml-12 -mt-28 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            alt=""
            src="/screenshots/vana2.png"
            className="mx-auto w-[21rem] max-w-none rounded-xl sm:w-[28rem]"
          />
        </div>
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              <p>
                Suyabakan Water Smart Valve, akıllı vana kontrolcüsü ve
                sensörleri ile donatılmış, tarımsal sulama işlemlerini kolayca
                yönetmenizi sağlar. Web veya mobil uygulama üzerinden uzaktan
                vana kontrolü yapabilir, sulama planları oluşturabilir veya
                sulama takvimi girebilirsiniz.
              </p>
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    Water Smart Valve, web ve mobil uygulama üzerinden vananızı
                    uzaktan açıp kapatmanızı sağlar. Bu özellik, sulama
                    işlemlerinizi daha esnek hale getirir.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <CalendarIcon
                  ...
                  <span>
                    ...
                    Hedeflerinize uygun olarak sulama planları oluşturun ve
                    sulama takvimi girin. Böylece bitkilerinizin ihtiyaç duyduğu
                    suyu zamanında almasını sağlayabilirsiniz.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <p
                    aria-hidden="true"
                    className="mt-1 h-5 w-5 flex-none text-xl text-indigo-600"
                  >
                  ...
                  <span>
                    ...
                    Vana girişinde ve çıkışında bulunan sensörler, sulama
                    sisteminizin verimliliğini artırmak için basınç kayıplarını
                    izler. Bu sayede sorunları önceden tespit edebilirsiniz.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <FunnelIcon
                  ...
                  <span>
                    ...
                    Su akış sayacı ile ne kadar su kullandığınızı takip edin. Bu
                    özellik, su kaynaklarınızı verimli bir şekilde yönetmenizi
                    sağlar.
                  </span>
                </li>
                <li className="flex gap-x-3">
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    Hızlı ve pratik kurulumu sayesinde Water Smart Valve’i tarla
                    ortamınıza kolayca entegre edin ve hemen kullanmaya
                    başlayın.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    Zorlu saha koşullarına dayanıklı yapısı ile uzun ömürlü ve
              ...
              <p className="mt-6">
                ...
                Sulamanızı kontrol etmenin farkını yaşayın.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 px-10">
          <dl className="divide-y divide-gray-100">
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd className="text- mt-1 text-gray-700 sm:col-span-2 sm:mt-0">
              1 Litre/Dakika - 250 Litre/Dakika
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text- font-medium text-gray-900">
              Basınç Ölçüm Hassasiyeti
              </dt>
              <dd className="text- mt-1 text-gray-700 sm:col-span-2 sm:mt-0">
              ±0.1 bar
              </dd>
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd className="text- mt-1 text-gray-700 sm:col-span-2 sm:mt-0">
              500 metreye kadar açık alanda
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text- font-medium text-gray-900">Su Geçirmezlik Seviyesi</dt>
              <dd className="text- mt-1 text-gray-700 sm:col-span-2 sm:mt-0">
              IP67
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text- font-medium text-gray-900">Çalışma Sıcaklığı</dt>
              <dd className="text- mt-1 text-gray-700 sm:col-span-2 sm:mt-0">
              -10°C ile +60°C
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text- font-medium text-gray-900">Veri Gönderim Aralığı</dt>
              <dd className="text- mt-1 text-gray-700 sm:col-span-2 sm:mt-0">
              1 Saat (kullanıcı tarafından ayarlanabilir)
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text- font-medium text-gray-900">Entegrasyon</dt>
              <dd className="text- mt-1 text-gray-700 sm:col-span-2 sm:mt-0">
              Suyabakan Assistant uygulaması ile uzaktan kontrol ve izleme
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              <dt className="text- font-medium text-gray-900">
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd className="text- mt-1 text-gray-700 sm:col-span-2 sm:mt-0">
              Elektrik kesintisi durumunda manuel kullanım seçeneği
              </dd>
            </div>
          </dl>
        </div>
            ...
            <div className="flex max-lg:mt-16 lg:col-span-2 lg:px-16">
              <figure className="mx-auto flex max-w-xl flex-col gap-16 max-lg:text-center">
                <blockquote>
                  ...
                  Suyabakan Water Smart Valve ile sulama sistemimizi tam anlamıyla kontrol altına aldık. Anlık veri takibi ve uzaktan kontrol özellikleri sayesinde suyu doğru zamanda, doğru miktarda kullanabiliyoruz. Bu teknolojiyle hem kaynaklarımızı daha verimli kullanıyor hem de tarla verimliliğimizi artırıyoruz.
                  </p>
                </blockquote>
                <figcaption className="mt-auto">
                  ...
                  <p className="text-sm/6 font-medium">
                    <span className="bg-gradient-to-r from-[#fff1be] from-[28%] via-[#ee87cb] via-[70%] to-[#b060ff] bg-clip-text text-transparent">
                      Farmer and VP of Sales, Protocol
                    </span>
                  </p>
                </figcaption>
              </figure>
        ...
        <section id="faqs" className="scroll-mt-8">
          ...
          <div className="mx-auto mb-32 mt-16 max-w-xl space-y-12">
            <dl>
              ...
              Suyabakan Water Smart Valve nasıl çalışır?
              </dt>
              <dd className="text/6 mt-4 text-gray-600">
              Akıllı vana, sulama hattınıza monte edilerek hem manuel hem de uzaktan kontrol imkanı sağlar. Üzerindeki basınç ve akış sensörleriyle suyun akışını ve hattaki basıncı takip eder.
              </dd>
            </dl>
            <dl>
              <dt className="text font-semibold">
              Cihazın kurulumu zor mu?
              </dt>
              <dd className="text/6 mt-4 text-gray-600">
              Hayır, Suyabakan Water Smart Valve hızlı ve kolay kurulum için tasarlanmıştır. Standart sulama hatlarına uygun bağlantı seçenekleri sunar.
              </dd>
            </dl>
            <dl>
              <dt className="text font-semibold">
              Su akışını uzaktan kontrol edebilir miyim?
              </dt>
              <dd className="text/6 mt-4 text-gray-600">
              Evet, Suyabakan Assistant uygulaması üzerinden su akışını uzaktan kontrol edebilir, anlık verileri görüntüleyebilirsiniz.
              </dd>
            </dl>
            <dl>
              <dt className="text font-semibold">
              Akıllı vana su basıncı ile ilgili sorunları tespit edebilir mi?
              </dt>
              <dd className="text/6 mt-4 text-gray-600">
              Evet, cihaz üzerindeki basınç sensörleri sayesinde hattaki düşük veya yüksek basıncı algılar ve bu durumla ilgili anlık bildirim sağlar.
              </dd>
            </dl>
            <dl>
              <dt className="text font-semibold">
              Cihazın pil ömrü ne kadar?
              </dt>
              <dd className="text/6 mt-4 text-gray-600">
              Suyabakan Water Smart Valve, uzun ömürlü bataryalarla donatılmıştır. Bu sayede enerji sıkıntısı yaşamadan bir sezon boyunca kullanabilirsiniz.
              </dd>
            </dl>
            <dl>
              <dt className="text font-semibold">
              Cihazı farklı sulama sistemleriyle kullanabilir miyim?
              </dt>
              <dd className="text/6 mt-4 text-gray-600">
              Evet, Suyabakan Water Smart Valve, damla sulama, yağmurlama ve diğer modern sulama sistemleriyle uyumlu olarak çalışır.
              </dd>
            </dl>
            <dl>
              <dt className="text font-semibold">
              Bakım gereksinimi var mı?
              </dt>
              <dd className="text/6 mt-4 text-gray-600">
              Cihaz dayanıklı yapısıyla uzun süreli kullanım için tasarlanmıştır. Sadece periyodik olarak sensörlerin temizliği yapılması önerilir.
              </dd>
            </dl>
          </div>
        </section>
      ...
      <div className="bg-gray-50 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-balance sm:text-5xl">
              Altyapını değiştirmeden akıllandır.
            </p>
            <p className="mt-6 text-lg/8 text-gray-600">
              Vananı değiştirerek sulama işlemlerini akıllandır. Suyabakan Water Smart Valve ile sulama işlemlerini uzaktan kontrol et, su tasarrufu sağla ve verimliliği artır.
            </p>
          </div>
        </div>
        <div className="relative overflow-hidden pt-4">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <img
              alt="App screenshot"
              src="/screenshots/watersmartvalveparts.png"
              width={962}
              height={2042}
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                ...
                <div className="relative min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                  <div className="absolute inset-x-0 bottom-0 top-0 -left-5 overflow-hidden rounded-t-[12cqw]">
                    <img
                      className="size-full object-cover object-top"
                      src="/screenshots/isoWaterSmartValve.png"
                      alt=""
                    />
                  </div>
                </div>
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                ...
                <div className="relative flex flex-1 items-center justify-center">
                  ...
                  <img
                    ...
                    src="/screenshots/watersmartvalvesetup.png"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative max-lg:h-[37rem] flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                <div className="z-10 px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  ...
                  <p className="/6 mt-2 max-w-lg text-gray-600 max-lg:text-center">
                    Basınç sensörleri sayesinde tıkanıklık durumlarını anında tespit edin.
                  </p>
                </div>
                <div className="absolute inset-x-0 -bottom-0 -z-0 overflow-hidden">
                  ...
                  <img
                    className="h-auto w-full sm:w-8/12 md:w-8/12 lg:w-full object-cover object-top"
                    src="/screenshots/basinckaybi.png"
                    alt=""
                  />
                </div>
              </div>
