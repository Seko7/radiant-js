...
function PricingCards() {
  const products = [
    ...
    {
      id: 2,
      name: 'Kablosuz Vana Kontrolcüsü',
      href: '#',
      price: '$35',
    ...
    {
      id: 6,
      name: 'Kablosuz Pompa Kontrolcüsü',
      href: '#',
      price: '$35',
      imageSrc: 'https://tailwindui.com/plus/img/ecommerce-images/category-page-04-image-card-02.jpg',
      imageAlt: 'Olive drab green insulated bottle with flared screw lid and flat top.',
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="-mx-px grid grid-cols-2 border-l border-gray-200 sm:mx-0 md:grid-cols-3 lg:grid-cols-4">
          {products.map((product) => (
            <div key={product.id} className="group relative border-b border-r border-white p-4 sm:p-6">
              <div className="aspect-h-1 aspect-w-1 aspect-square  overflow-hidden rounded-lg bg-gray-200 group-hover:opacity-75">
                <img
                  alt={product.imageAlt}
                  src={product.imageSrc}
