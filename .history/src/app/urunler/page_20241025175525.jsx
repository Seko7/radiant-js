    ...
    <div className="bg-white mt-10 mb-20 ">
      <div className="mx-auto max-w-7xl overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className=" -mx-px grid grid-cols-2 border-l border-gray-200 sm:mx-0 md:grid-cols-3 lg:grid-cols-4">
          {products.map((product) => (
            <div key={product.id} className="hover:bg-red-300 hover:!cursor-pointer  group relative border-b border-r border-white-200 p-4 sm:p-6">
              <div className="aspect-h-1 aspect-w-1 aspect-square  overflow-hidden rounded-lg bg-white ">
                <img
                  alt={product.imageAlt}
                  src={product.imageSrc}
