  ...
  return (
    <div className="bg-white mt-10 mb-20">
      <div className="mx-auto max-w-7xl overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="-mx-px grid grid-cols-2 borde shadow-md border-gray-200 sm:mx-0 md:grid-cols-3 lg:grid-cols-4">
          {products.map((product) => (
            <div key={product.id} className="group relative border- border- border-white-200 p-4 sm:p-6">
