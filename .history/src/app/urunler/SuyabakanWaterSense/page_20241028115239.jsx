 ...
 function PricingCards() {
  return (
    <div className="relative isolate overflow-hidden  px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      ...
      <div className="bg-red-700 mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        <div className="bg-red-600 lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
        ...
        <div className="bg-red-500 -ml-12 -mt-28 p-12 px-0 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            alt=""
            src="/screenshots/suseviye.png"
            className="w-[18rem] max-w-none rounded-xl  mx-auto sm:w-[30rem]"
          />
        </div>
        <div className="bg-red-300 lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="bg-red-400 lg:pr-4">
            <div className="max-w-2xl text-base leading-7 text-gray-700 lg:max-w-4xl">
              <p>
