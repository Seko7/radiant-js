      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-ml-12 -mt-28 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            ...
            className="w-[27rem] max-w-none rounded-xl  mx-auto sm:w-[27rem]"
          />
        </div>
            ...
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">Rüzgar Hızı.</strong> Suyabakan Soil Sense yekpare yapıya sahip olup saha şartlarına karşı yüksek dayanıklılık gösterir. En zorlu hava koşullarında bile performansını sürdürür.
                  </span>
                </li>
                <li className="flex gap-x-3">
                ...
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Katmanlı nem ve sıcaklık ölçümü.</strong> Farklı derinliklerde yer alan sensörleri sayesinde toprağın çeşitli katmanlarındaki nem ve sıcaklık verilerini toplar. Böylece sulama ihtiyaçlarını daha hassas bir şekilde belirleyebilirsiniz.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-indigo-600" />
