    ...
    <Container className="py-24">
      <div>
        <div className="px-4 sm:px-10">
          ...
          <p className="mt-1 max-w-2xl text- text-gray-500">
        ...
        <div className="mt-6 px-10">
          <dl className="divide-y divide-gray-100">
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd className="mt-1 text- text-gray-700 sm:col-span-2 sm:mt-0">
                Hacimsel Su Miktarı
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <figure className="mx-auto flex max-w-xl flex-col gap-16 max-lg:text-center">
              <blockquote>
                <p className="relative text-3xl tracking-tight text-white before:absolute before:-translate-x-full before:content-['“'] after:absolute after:content-['”'] lg:text-4xl">
                  Suyabakan Soil Sense ile toprağın nem ve sıcaklık verilerini anlık olarak takip edebiliyoruz. Bu sayede sulama yönetimimizi daha verimli bir şekilde gerçekleştirebiliyoruz.
                </p>
              </blockquote>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-lg/8 text-gray-600">
            Bitki türünüz değiştiğinde, Suyabakan Soil Sense değişir. Tarla, bağ veya bağçe bitkilerine göre uygun ürünü seçip bitkilerinizin sağlıklı büyümesini sağlayın. 
          </p>
        </div>
      </div>
        ...
        <div className="mt-1 grid gap-4 sm:mt-1 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                  Çeşitli derinlikteki sensörler sayesinde suyun bitkinin köklerine ulaşma sürecini izleyin.
                </p>
              </div>
          ...
          <div className="relative max-lg:row-start-1">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">Hızlı ve masrafsız kurulum.</p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                  Kurulumu "Del ve Yerleştir" prensibiyle 2 dakikadan kısa sürede masrafsız tamamlayın.
                </p>
              </div>
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">Gerçek zamanlı bulut sistemi</p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                  Veriler anlık olarak bulut sistemimiz üzerinden hızlı bir şekilde toplanır.
                </p>
              </div>
          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10 z-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">
