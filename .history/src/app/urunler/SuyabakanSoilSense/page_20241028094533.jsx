          ...
          <div className="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
            <div>
              <div className="border-b border-gray-200 pb-10">
                <h2 className="font-medium text-indigo-600">Machined Kettle</h2>
                <p className="mt-0 text-3xl font-medium tracking-tight text-gray-950 sm:text-5xl">Suyabakan Soil Sense</p>
              </div>
              ...
              <dl className="mt-10 space-y-10">
                {features.map((feature) => (
                  <div key={feature.name}>
                    ...
                    <dd className="mt-3 text-lg text-gray-500">{feature.description}</dd>
                  </div>
                ))}
              </dl>
            </div>
            ...
            <div>
              <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray00">
                <img
                  alt="Black kettle with long pour spot and angled body on marble counter next to coffee mug and pour-over system."
                  src="/screenshots/izci.png"
                  className="h-[60rem] w-auto object-cover object-center"
                />
              </div>
