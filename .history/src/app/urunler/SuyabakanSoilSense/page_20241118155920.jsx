...
function Product() {
  return (
    <div className="relative isolate overflow-hidden px-6 py-24 sm:py-32 max-sm:py-12 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-ml-12 -mt-28 max-sm:-mt-12 max-sm:-ml-4 max-sm:p-5 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            alt=""
      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <div className="mt-1 grid gap-4 sm:mt-1 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="relative max-sm:h-[37rem] sm:h-[37rem] md:h-[37rem] flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              <div className="z-10 px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">
                  Etkin Kök Bölgesi Tespiti
                </p>
                <p className="/6 mt-2 max-w-lg text-gray-600 max-lg:text-center">
                  Farklı derinliklerdeki sensörler sayesinde bitkinin kök bölgesi ve suya ulaşma sürecini izleyin.
                </p>
              </div>
              <div className="absolute inset-x-0 -bottom-5 -z-0 overflow-hidden">
                ...
                <img
                  className="h-auto md:h-[20rem] w-full object-cover object-top "
