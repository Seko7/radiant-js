      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-balance sm:text-5xl">
            Her bitki için uygun çözüm.
          </p>
          <p className="mt-6 text-lg/8 text-gray-600">
            Bitki türünüz değiştiğinde, Suyabakan Soil Sense değişir. Her bitki türü için uygun olan toprak nem ve sıcaklık değerlerini belirleyerek, bitkilerinizin sağlıklı büyümesini sağlayın. 
          </p>
        </div>
      </div>
      <div className="relative overflow-hidden pt-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 ">
          ...
          <div aria-hidden="true" className="relative">
            <div className="absolute -inset-x-20 bottom-0 bg-gradient-to-t from-white pt-[2%]" />
          </div>
        </div>
      </div>
