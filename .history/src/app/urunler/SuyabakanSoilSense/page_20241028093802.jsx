          ...
          <div className="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
            <div>
              <div className="border-b border-gray-200 pb-10">
                <h2 className="font-medium text-gray-500">Suyabakan Soil Sense</h2>
                <p className="mt-0 text-3xl font-medium tracking-tight text-gray-950 sm:text-5xl">Elegant simplicity</p>
              </div>
