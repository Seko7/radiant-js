  ...
  return (
    <div className="relative">
      ...
      <Container className="relative">
        ...
        <div className="flex relative flex-row pb-24 pt-16 sm:pb-32 sm:pt-24 md:pb-96 md:pt-28">
          ...
          <img
            ...
            className="absolute -z-10 rounded-4xl -ml-[7rem] top-[-5rem] max-w-[118%]"
          />
        </div>
      </Container>
    </div>
    ...
    <Container>
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
        ...
        <BentoCard
          ...
          graphic={
            <div className="h-80 bg-[url(/screenshots/meteoroloji.png)]   bg-contain mx-20 bg-[right_0px_top_80px] bg-no-repeat" />
          }
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                  Toprak altından hava durumuna, depo seviyesinden vanalara birçok sensör ile tarlanızı kontrol edin.
                </p>
                <button
        type="button"
