      ...
      <Container className="relative">
        ...
        <div className=" relative flex flex-row pb-24 pt-4 sm:pb-32 sm:pt-24 md:pb-96 md:pt-28">
          <div className="relative z-10 w-full">
            ...
            <div className="lg:mt-12 max-sm:mt-8 mb-28 lg:mb-0 flex flex-col gap-x-6 gap-y-4 sm:flex-row bg-white">
          ...
          <img
            ...
            className="absolute lg:top-[-5rem] -z-10 lg:-ml-[12rem] -bottom-40 -ml-80 max-w-[180%] lg:max-w-[118%] rounded-4xl"
          />
        </div>
      </Container>
    </div>
