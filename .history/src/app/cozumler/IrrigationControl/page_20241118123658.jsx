      ...
      <main>
        ...
        <div className="flex flex-col border-b border-gray-200 lg:border-0">
          <div className="relative">
                ...
                <div className="mx-auto max-w-2xl max-sm:py-12 py-24 lg:max-w-none lg:py-32">
                  <div className="lg:pr-16">
                    <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl xl:text-6xl">
                      Sulamayı kontrol altına almak isteyenler için
                    </h1>
                    <p className="mt-4 text-xl text-gray-600">
                      Bitki ihtiyacı kadar sulama yapmak, değişken sulama ihtiyaçlarını kontrol etmek isteyenler için geliştirildi.
                    </p>
                    <div className="mt-6">
                      <a
                        href="/iletisim"
            ...
            <div className="z-0 h-80 max-sm:-mt-12 w-full sm:h-64 lg:absolute lg:-top-10 lg:-right-10 lg:h-auto lg:w-2/3">
        ...
        {/* Trending products */}
        <section aria-labelledby="trending-heading" className="bg-gray-100 z-50 relative">
  ...
  return (
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
        <p className="text-base/7 font-semibold text-indigo-600">Sulamayı kontrol et</p>
        <h1 className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
        Akıllı vana ile hassas ve etkin sulama yönetimi
        </h1>
        <p className="mt-6 text-xl/8">
        Suyabakan Water Smart Valve, Base Station Solar ve Suyabakan Assistant ile sulama sisteminizi kontrol altında tutun, su kaynaklarını en verimli şekilde kullanarak tarım verimliliğinizi artırın. Basınç ve akış sensörleri ile desteklenen bu çözüm, sulamayı ihtiyaçlara göre ayarlayıp izlemenizi sağlar.
        </p>
        <div className="mt-10 max-w-2xl">
          <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
            <li className="flex gap-x-3">
              ...
              <span>
                <strong className="font-semibold text-gray-900">Akıllı sulama planlaması ve takibi.</strong> Suyabakan Water Smart Valve, sahip olduğu basınç ve akış sensörleri sayesinde sulama miktarını ve basıncını anlık olarak ölçerek sulama sisteminizi optimize eder. Bu sayede, tarlanızdaki bitkilerin ihtiyacına uygun sulama miktarını otomatik olarak ayarlayabilir ve su israfını en aza indirirsiniz. Aynı zamanda, sulama sistemindeki anormallikleri tespit edip alarm üretebilir, böylece hızlı müdahalede bulunabilirsiniz.
              </span>
            </li>
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
              <span>
                <strong className="font-semibold text-gray-900">Güçlü ve dayanıklı iletişim.</strong> Base Station Solar, tüm Suyabakan cihazlarının kablosuz iletişimini sağlayan çevre dostu bir merkez istasyondur. Güneş enerjisi ile çalışarak hem güvenli bir veri aktarımı sunar hem de sürdürülebilir bir çözüm sağlar. Akıllı vanadan alınan veriler kesintisiz olarak Base Station üzerinden aktarılır, böylece sulama kontrolünüz her an elinizin altında olur.
                 </span>
            </li>
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
              <span>
                <strong className="font-semibold text-gray-900">Akıllı destek ve etkin sulama planlaması.</strong> Suyabakan Assistant, basınç ve akış verilerini analiz ederek size akıllı sulama destekleri sunar. Geçmiş verileri inceleyerek gelecekteki sulama gereksinimlerini öngörmenize ve sulama düzenlemelerini optimize etmenize yardımcı olur. Assistant’ın karar destek sistemleri, bitkilerinizin su ihtiyacına göre ideal sulama zamanlarını ve miktarını önerir, bu sayede bilinçli ve verimli bir sulama yapabilirsiniz.
                </span>
            </li>
          </ul>
          <p className="mt-8">
          Sulama Kontrolü çözümü ile suyu verimli kullanarak bitkilerin ihtiyaçlarını doğru zamanda karşılayabilir, böylece tarla sağlığını ve bitki gelişimini desteklerken su tasarrufu sağlayabilirsiniz. Suyabakan’ın yenilikçi yaklaşımı ile tarımda çevre dostu bir sulama çözümüne adım atın.
          </p>
          <h2 className="mt-16 text-pretty text-3xl font-semibold tracking-tight text-gray-900">
          Dakikalar İçinde Profesyonel Sulama Yönetimi
          </h2>
          <p className="mt-6">
          Suyabakan ürünleri, sulama yönetiminde uzmanlaşmanıza olanak tanır. Kolay kurulum adımları ve kullanıcı dostu arayüzü ile tüm sulama kontrolü anında elinizde. Akıllı analizler ve geçmiş verilerin değerlendirilmesi, sulama kararlarınızı daha etkili ve bilinçli bir hale getirir.
          </p>
          <figure className="mt-10 border-l border-indigo-600 pl-9">
            <blockquote className="font-semibold text-gray-900">
              <p>
              “Suyabakan ile sulama kararlarımızı, bitkilerin ihtiyaçlarını en iyi şekilde karşılayacak biçimde optimize edebiliyoruz. Kullanıcı dostu arayüzü sayesinde tüm veriler elimizin altında.”
              </p>
            </blockquote>
        ...
        <figure className="mt-16">
          <img
            ...
            src="/screenshots/cozumVana.png"
            className="aspect-[16/10] w-full h-auto rounded-xl bg-gray-50 object-cover"
          />
        ...
        <div className="mt-16 max-w-2xl">
          ...
          Kolay Başlangıçla Eksiksiz Sulama Çözümü
          </h2>
          <p className="mt-6">
          Suyabakan sulama çözümleri, akıllı tarıma hızlı bir geçiş yapmak isteyenler için kolay bir başlangıç sunar. Basit kurulumu ile cihazlarınızı dakikalar içinde aktif hale getirir, tüm sistemi kısa sürede kullanmaya başlayabilirsiniz.
          </p>
          <p className="mt-8">
          Akıllı tarımın tüm avantajları, etkili sulama yönetimi ve tarımsal verimliliği artırmak için bir arada. Tarlanızı daha verimli ve sürdürülebilir bir şekilde yönetmek için Suyabakan çözümlerini hemen kullanmaya başlayın!
          </p>
        </div>
      </div>
    </div>
