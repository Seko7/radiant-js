              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:grid lg:grid-cols-2 lg:px-8">
                <div className="mx-auto max-w-2xl py-24 lg:max-w-none lg:py-32">
                  <div className="lg:pr-16">
                    ...
                    Sulama sisteminin tüm parçalarını kontrol etmek, bitki ihtiyacı kadar sulama yapmak, değişken sulama ihtiyaçlarını kontrol etmek isteyenler için geliştirildi.
