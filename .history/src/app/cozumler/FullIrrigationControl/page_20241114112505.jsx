      ...
      <main>
        ...
        <div className="z-0 relative flex flex-col border-b border-gray-200 lg:border-0">
          <div className="relative">
            ...
            <div className="z-0 h-48 bg-red-400  w-full sm:h-64 lg:absolute lg:-top-2 lg:right-0 lg:h-auto lg:w-2/3">
          ...
          <div className="py-10 sm:py-24 lg:mx-auto lg:mt-[9.7rem] lg:max-w-7xl lg:px-8 lg:py-10">
            ...
            <div className="relative mt-8">
              <div className="relative w-full overflow-x-auto">
                <div className="bg-red-300 w-full mx-4 inline-flex space-x-8 sm:mx-6 lg:mx-0 lg:flex lg:flex-row lg:overflow-x-auto">
                  {trendingProducts.map((product) => (
                    <a
                      href={product.href}
                      key={product.id}
                      className="inline-flex w-64 flex-col text-center lg:w-"
                    >
                      <div className="group relative">
                        <div className="aspect-h-1 aspect-w-1 flex bg-red-300 items-center justify-center overflow-hidden rounded-md bg-white p-2 py-12">
                          <img
                            alt={product.name}
