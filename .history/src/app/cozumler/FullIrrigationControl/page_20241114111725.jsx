          ...
          <div className="py-10 sm:py-24 lg:mx-auto lg:mt-[9.7rem] lg:max-w-7xl lg:px-8 lg:py-10">
            ...
            <div className="relative mt-8">
              <div className="relative w-full overflow-x-auto">
                <div className="mx-4 bg-red-300 overflow-scroll sm:mx-6 lg:mx-0 lg:flex lg:grid-cols-4 lg:gap-x-8 lg:space-x-0">
                  {trendingProducts.map((product) => (
                    <a
                      href={product.href}
                      key={product.id}
                      className=" w-64 flex-col text-center lg:w-80"
                    >
