      ...
      <main>
        ...
        <div className="flex flex-col border-b border-gray-200 lg:border-0">
          <div className="relative">
            ...
            <div className="z-0 h-48 overflow-hidden w-full sm:h-64 lg:absolute lg:-top-2 lg:right-0 lg:h-auto lg:w-2/3">
              <div className="absolute inset-bot bg-gradient-to-r from-white to-15% group-data-[dark]:from-gray-800 group-data-[dark]:from-[-25%]" />
