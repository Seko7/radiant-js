          ...
          <div className="py-10 sm:py-24 lg:mx-auto lg:mt-[9.7rem] lg:max-w-7xl lg:px-8 lg:py-10">
            ...
            <div className="relative mt-8">
              <div className="relative w-full  ">
                <div className="mx-4 flex flex-row bg-red-300 gap-8 w-full overflow-scroll sm:mx-6 lg:mx-0 ">
                  {trendingProducts.map((product) => (
                    <a
                      href={product.href}
                      key={product.id}
                      className="inline-flex w-64 bg-green-400 flex-col text-center lg:w-80"
                    >
