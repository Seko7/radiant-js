      ...
      <main>
        ...
        <div className="flex flex-col border-b border-gray-200 lg:border-0">
          <div className="relative">
            ...
            <div className="z-0 h-80 max-sm:-mt-32 w-full sm:h-64 lg:absolute lg:-top-10 lg:-right-10 lg:h-auto lg:w-2/3">
      ...
      <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
        ...
        <figure className="mt-16">
          <img
            ...
            src="/screenshots/cozumToprakMeteo.png"
            className="aspect-[16/12] w-full h-auto rounded-xl bg-gray-50 object-cover object-center  "
          />
