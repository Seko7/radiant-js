      ...
      <main>
        ...
        <div className="flex flex-col border-b border-gray-200 lg:border-0">
          <div className="relative">
                ...
                <div className="mx-auto max-w-2xl max-sm:py-12 py-24 lg:max-w-none lg:py-32">
                  <div className="lg:pr-16">
                    ...
                    <p className="mt-4 text-xl text-gray-600">
                      Bölgesel iklimi takip etmek, hava durumunu takip etmek ve bitkinin ihtiyacını anlamak
                     için geliştirildi.
                    </p>
                    <div className="mt-6">
                      <a
            ...
            <div className="z-0 h-80 max-sm:-mt-10 w-full sm:h-64 lg:absolute lg:-top-8 lg:-right-0 lg:h-auto lg:w-2/3">
  ...
  return (
    <div className=" ml-1 mr-6 max-sm:mr-6 my-6 flex flex-row rounded-4xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:w-full max-lg:max-w-md">
      <div className="flex flex-row rounded-4xl p-2 shadow-md shadow-black/5">
        <div className="relative flex flex-col justify-between rounded-3xl w-96 max-sm:w-80 h-[40rem] bg-white p-0 pb-0  ring-1 ring-black/5">
          <p className="mt-6 px-8 text-xl">{tier.name}</p>
          <p className="mt-2 px-8 text-sm/6 text-gray-950/75">
            {tier.description}
          </p>
  ...
  return (
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
        ...
        Tarla iklimini ve hava koşullarını anlık takip edin
        </h1>
        <p className="mt-6 text-xl/8">
        Tarla ikliminizin ayrıntılı verilerine Suyabakan Air Sense, Base Station Solar ve Suyabakan Assistant ile ulaşarak daha sağlıklı bitki gelişimi sağlayın. Meteorolojik verileri anlık olarak gözlemleyerek hava durumu ve çevresel faktörleri kontrol altına alın.
        </p>
        <div className="mt-10 max-w-2xl">
          <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
            <li className="flex gap-x-3">
              ...
              <span>
                <strong className="font-semibold text-gray-900">Anlık hava koşulları verileri.</strong> Suyabakan Air Sense, rüzgar hızı, rüzgar yönü, hava sıcaklığı, hava nemi ve aydınlanma düzeyi gibi meteorolojik verileri toplar. Bu değerler tarla ve ürün sağlığı üzerinde doğrudan etkilidir. Hava koşullarını anlık olarak izleyerek tarlanızda oluşabilecek iklim değişimlerini önceden fark edebilir, bitkilerinizin ihtiyaçlarını anında karşılayabilirsiniz. Örneğin, rüzgar yönü ve hızını gözlemleyerek püskürtme veya sulama planlamalarınızı daha isabetli yapabilir, ani sıcaklık değişimlerine göre önlemler alabilirsiniz.
              </span>
            </li>
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
              <span>
                <strong className="font-semibold text-gray-900">Güçlü ve dayanıklı iletişim.</strong> Base Station Solar, Air Sense’in topladığı verileri kesintisiz bir şekilde size ileterek tüm verilerin güvenilir bir şekilde ulaşmasını sağlar. Güneş enerjisiyle çalışan ve kablosuz haberleşme sağlayan bu merkez istasyon, çevre dostu yapısıyla verilerinizin her an elinizin altında olmasını sağlar. Böylece tarlanızdaki hava koşullarını sürekli kontrol altında tutabilirsiniz.
              </span>
            </li>
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
              <span>
                <strong className="font-semibold text-gray-900">Akıllı destek ve analizler.</strong> Suyabakan Assistant, hava verilerini yalnızca izlemekle kalmaz; aynı zamanda kapsamlı analizler sunarak tarımsal faaliyetlerinizi optimize etmenize yardımcı olur. Geçmiş veriler üzerinden hava değişimlerini gözlemleyerek sulama, gübreleme ve hasat gibi işlemlerinizde karar destek sağlar. Assistant’ın sunduğu analiz ve öngörüler, sezgiler yerine hava durumuna dayalı veriye dayalı kararlar almanıza olanak tanır.
              </span>
            </li>
          </ul>
          <p className="mt-8">
          Havayı İzleme çözümü, tarla ikliminizin değişkenliklerini kontrol altında tutarak daha sağlıklı bir tarım yapmanızı sağlar. Suyabakan ile hava koşullarını izlemek, daha çevreci ve sürdürülebilir bir yaklaşım sunarak bitkilerinizin ihtiyaçlarını doğru zamanda ve miktarda karşılamanızı sağlar.
          </p>
          <h2 className="mt-16 text-pretty text-3xl font-semibold tracking-tight text-gray-900">
            Dakikalar içinde uzmana dönüşün
          </h2>
          <p className="mt-6">
          Suyabakan ürünleri ile tarım teknolojilerinde ustalaşmak hiç bu kadar kolay olmamıştı. İster yeni başlayan, ister deneyimli bir çiftçi olun; kullanıcı dostu arayüzü ve kolay kurulumu sayesinde Suyabakan, sizi hızlıca profesyonel düzeye taşır. Anlık bilgilendirme ve geçmiş verileri analiz edebilme imkanı, kararlarınızı daha verimli hale getirir.
          </p>
