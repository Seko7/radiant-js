      ...
      <main>
        ...
        <div className="flex flex-col border-b border-gray-200 lg:border-0">
          <div className="relative">
            ...
            <div className="z-0 h-80 w-full sm:h-64 lg:absolute lg:-top-32 lg:right-0 lg:h-auto lg:w-2/3">
              ...
              <img
                ...
                className="h-full max-sm:h-auto w-full  object-cover object-center"
              />
            </div>
          </div>
        </div>
