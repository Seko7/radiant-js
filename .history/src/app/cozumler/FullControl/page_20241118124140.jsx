      ...
      <main>
        ...
        <div className="z-0 relative flex flex-col border-b border-gray-200 lg:border-0">
          <div className="relative">
            ...
            <div className="z-0 h-80 max-sm:-mt-12 w-full sm:h-64 lg:absolute lg:-top-28 lg:-right-10 lg:h-auto lg:w-2/3">
              ...
              <img
                alt=""
                src="/screenshots/cozumFull.png"
                className="h-full w-full max-w-5xl object-cover object-center"
