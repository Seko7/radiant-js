      ...
      <main>
        ...
        <div className="z-0 relative flex flex-col border-b border-gray-200 lg:border-0">
          <div className="relative">
            ...
            <div className="z-0 h-48 max-sm:h-80 bg-red-400  w-full sm:h-64 lg:absolute lg:-top-8 lg:right-0 lg:h-auto lg:w-2/3">
              <div className="absolute inset-0 bg-gradient-to-r from-white to-15% group-data-[dark]:from-gray-800 group-data-[dark]:from-[-25%]" />

              <img
                alt=""
                src="/screenshots/cozumFull.png"
                className="h-[50rem] max-sm:h-auto w-full object-cover object-center "
              />
            </div>
          </div>
        </div>
        ...
        {/* Trending products */}
        <section aria-labelledby="trending-heading" className="bg-gray-100 relative z-50">
          <div className="py-10 sm:py-24 lg:mx-auto lg:mt-[9.7rem] lg:max-w-7xl lg:px-8 lg:py-10">
            ...
            <div className="relative mt-8">
              ...
              <div className="mx-4 inline-flex space-x-8 sm:mx-6 lg:mx-0 pb-4 lg:flex lg:grid-cols-4 lg:gap-x-8 lg:space-x-0">
                  ...
                  {trendingProducts.map((product) => (
                    ...
                    >
                      <div className="group relative">
                        <div className="aspect-h-1 aspect-w-1 flex w-full lg:w-64 items-center justify-center overflow-hidden rounded-md bg-white p-2 py-12">
                          <img
                            alt={product.name}
