                  ...
                  {trendingProducts.map((product) => (
                    <li key={product.id} className="inline-flex w-64 flex-col text-center lg:w-auto">
                      <div className="group relative">
                        <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden items-center object-center content-center place-items-center rounded-md bg-red-300">
                          <img
                            alt={product.imageAlt}
                            src={product.imageSrc}
                            className="h-60 w-auto object-cover object-center bg-red-600 group-hover:opacity-75"
                          />
                        </div>
                        <div className="mt-6">
