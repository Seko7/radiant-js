...
function PricingCards() {
  return (
    <div className="relative py-24 h-fit">
  ...
  return (
    <div className="-m-2 grid grid-cols-1 rounded-4xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:w-full max-lg:max-w-md">
      <div className="grid grid-cols-1 rounded-4xl p-2 shadow-md shadow-black/5">
        <div className="relative rounded-3xl flex flex-col justify-between bg-white p-0 pb-0 shadow-2xl ring-1 ring-black/5">
          <p className='px-8 mt-6 text-xl '>{tier.name}</p>
          <p className="mt-2 text-sm/6 text-gray-950/75 px-8">{tier.description}</p>
          ...
          <div className="relative  mt-0 flex items-center gap-0 overflow-hidden rounded-3xl ">
            ...
            <img src={tier.src} alt='pricing-table' className='w-full  relative' />
          </div>
        </div>
      </div>
    </div>
      ...
      <main>
        ...
        <div className="flex flex-col border-b border-gray-200 lg:border-0">
          ...
          <div className="relative ">
                ...
                <div className="mx-auto max-w-2xl py-24 lg:max-w-none lg:py-32">
                  <div className="lg:pr-16">
                    ...
                    <p className="mt-4 text-xl text-gray-600">
                      Toprağın durumunu takip etmek, bitkinin ihtiyacını anlamak ve kök durumunu takip etmek için geliştirildi.
                    </p>
                    <div className="mt-6">
                      <a
                        href="#"
            ...
            <div className="h-48 w-full z-0 sm:h-64 lg:absolute lg:right-0 lg:-top-32 lg:h-auto lg:w-2/3">
        ...
        <section aria-labelledby="trending-heading" className="bg-gray-100">
          <div className="py-10 sm:py-24 lg:mx-auto lg:max-w-7xl lg:px-8 lg:py-10 lg:mt-[9.7rem]">
            <div className="flex items-center justify-between px-4 sm:px-6 lg:px-0">
              <h2 id="trending-heading" className="text-2xl font-bold tracking-tight text-gray-900">
                Kullanılan ürünler
              </h2>
              <a href="/urunler" className="hidden text-sm font-semibold text-indigo-600 hover:text-indigo-500 sm:block">
                tümünü gör
              ...
              <div className="relative w-full overflow-x-auto">
                ...
                >
                  {trendingProducts.map((product) => (
                    <a href={product.href}  key={product.id} className="inline-flex w-64 flex-col text-center lg:w-auto">
                      <div className="group relative">
                        <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden flex items-center justify-center bg-white p-2 py-12 rounded-md ">
                          <img
                            alt={product.name}
                        ...
                        <div  className="mt-6">
                          <p className="text-sm text-indigo-600">{product.color}</p>
            ...
            <div className="mt-12 px-4 sm:hidden">
              <a href="/urunler" className="text-sm font-semibold text-indigo-600 hover:text-indigo-500">
                tümünü gör
                <span aria-hidden="true"> &rarr;</span>
              </a>
            </div>
...
function Cozumler() {
    return (
      <div className="relative py-24 h-fit">
        <Gradient className="absolute inset-x-2 bottom-0 top-48 rounded-4xl ring-1 ring-inset ring-black/5" />
        <Container className="relative">
          <div className="flex flex-row bg-red-300 overflow-x-auto overflow-y-hidden gap-8 ">
            {tiers.map((tier, tierIndex) => (
  ...
  function Cozum({ tier }) {
    return (
      <div className="-m-2 w-60  grid grid-cols-1 rounded-4xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:w-full max-lg:max-w-md">
        <div className="grid grid-cols-1 rounded-4xl p-2 shadow-md shadow-black/5 bg-blue-600 w-96">
          <div className="relative rounded-3xl flex flex-col justify-between bg-white p-0 pb-0 shadow-2xl ring-1 ring-black/5">
            <p className='px-8 mt-6 text-xl '>{tier.name}</p>
            <p className="mt-2 text-sm/6 text-gray-950/75 px-8">{tier.description}</p>
