  ...
  return (
    <div className="relative h-fit py-24">
      ...
      <div className="flex items-center justify-between px-4 sm:px-6 lg:px-0">
        ...
        <div className="flex flex-row gap-0 overflow-visible overflow-x-scroll p-0">
...
function Cozum({ tier }) {
  return (
    <div className="mr-6 my-32 flex flex-row rounded-4xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:w-full max-lg:max-w-md">
