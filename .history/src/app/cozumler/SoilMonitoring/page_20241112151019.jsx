                  ...
                  {trendingProducts.map((product) => (
                    <li  key={product.id} className="inline-flex w-64 flex-col text-center lg:w-auto">
                      <div className="group relative">
                        <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden flex items-center justify-center bg-white p-6 py-10 rounded-md ">
                          <img
                            alt={product.imageAlt}
                            src={product.imageSrc}
                            className="h-40 w-auto object-cover object-center group-hover:opacity-75"
                          />
                        </div>
                        <div className="mt-6">
