...
function Cozum({ tier }) {
  return (
    <div className="m-8 flex flex-row rounded-4xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:w-full max-lg:max-w-md">
      <div className="flex flex-row rounded-4xl p-2 shadow-md shadow-black/5">
        <div className="relative flex flex-col justify-between rounded-3xl w-40 bg-white p-0 pb-0 shadow-2xl ring-1 ring-black/5">
          <p className="mt-6 px-8 text-xl">{tier.name}</p>
          <p className="mt-2 px-8 text-sm/6 text-gray-950/75">
            {tier.description}
          </p>
