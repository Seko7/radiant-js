...
function Cozum({ tier }) {
  return (
    <div className="-m-2 grid w-60 grid-cols-1 rounded-4xl shadow-[inset_0_0_2px_1px_#ffffff4d] ring-1 ring-black/5 max-lg:mx-auto max-lg:w-full max-lg:max-w-md">
      <div className="flex flex-row rounded-4xl bg-blue-600 p-2 shadow-md shadow-black/5">
