      ...
      <main>
        ...
        <div className="flex flex-col border-b border-gray-200 lg:border-0">
          ...
          <div className="relative ">
            ...
            <div className="h-48 w-full z-0 sm:h-64 lg:absolute lg:right-0 lg:-top-28 lg:h-auto lg:w-2/3">
        ...
        <section aria-labelledby="trending-heading" className="bg-gray-100">
          <div className="py-10 sm:py-24 lg:mx-auto lg:max-w-7xl lg:px-8 lg:py-10 lg:mt-44">
