          ...
          <div className="relative">
            ...
            <div className="z-0 h-48 w-full sm:h-64 lg:absolute lg:-top-32 lg:right-0 lg:h-auto lg:w-2/3">
              ...
              <img
                ...
                className="h-full w-full max-w-5xl object-cover object-right-bottom"
              />
            </div>
          </div>
        </div>
                      ...
                      <div className="group relative">
                        <div className="aspect-h-1 aspect-w-1 flex w-full items-center justify-center overflow-hidden rounded-md bg-white p-2 py-12">
                          <img
                            ...
                            className="h-48 w-auto lg:w-64 object-contain object-center group-hover:opacity-75"
                          />
                        </div>
                        <div className="mt-6">
      ...
      <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
        ...
        <figure className="mt-16">
          <img
            ...
            src="/screenshots/cozumToprak.png"
            className="aspect-[16/9] w-full h-auto rounded-xl bg-gray-50 object-center object-cover"
          />
