...
function Cozumler() {
  return (
    <div className="relative h-fit py-0">
      {/* <Gradient className="absolute inset-x-2 bottom-0 top-48 rounded-4xl ring-1 ring-inset ring-black/5" /> */}
      <Container className="relative py-10 sm:py-24 lg:mx-auto lg:mt-[2.7rem] lg:max-w-7xl lg:px-8 lg:py-10">
      <div className="flex items-center justify-between px-4 sm:px-6 lg:px-0">
              <h2
                id="trending-heading"
                className="text-2xl font-bold tracking-tight text-gray-900"
    ...
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
        ...
        <div className="mt-10 max-w-2xl">
          ...
          <p className="mt-8">
          Toprağı İzle çözümünün sunduğu bu derinlemesine bilgi akışı ile bitkilerinizin ihtiyaçlarını zamanında ve doğru miktarda karşılayarak daha verimli bir tarım yapabilir, su israfını önleyebilir ve toprağınızın uzun vadeli sağlığını koruyabilirsiniz. Suyabakan ile toprağınızı izlemek, hem çevre dostu hem de ekonomik bir yaklaşım sunar.
          </p>
        ...
        <figure className="mt-16">
          <img
            ...
            src="/screenshots/cozumToprak.png"
            className="aspect-video w-full object-cover rounded-xl bg-gray-50 object-cover"
          />
