              ...
              <div className="relative w-full overflow-x-auto">
                ...
                >
                  {trendingProducts.map((product) => (
                    <a href={product.href} key={product.id} className="inline-flex w-64 flex-col text-center lg:w-auto bg-black">
                      <div className="group relative">
                        <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden items-center object-center flex rounded-md bg-white py-5">
                          <img
                            alt={product.imageAlt}
                            src={product.imageSrc}
                            className="h-60 p-5 w-auto object-cover object-center mx-auto  group-hover:opacity-75"
                          />
                        </div>
                        <div className="mt-6">
