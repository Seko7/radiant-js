...
function Hero() {
  return (
    <div className="relative">
      <Gradient className="absolute inset-2 -z-20 bottom-0 rounded-4xl ring-1 ring-inset ring-black/5" />
      ...
      <Container className="relative">
        ...
        <div className="flex relative flex-row pb-24 pt-16 sm:pb-32 sm:pt-24 md:pb-56 md:pt-28">
          ...
          <img
            ...
            className="absolute -z-10 -ml-[7rem] top-[-3rem] max-w-[118%]"
          />
        </div>
      </Container>
    </div>
