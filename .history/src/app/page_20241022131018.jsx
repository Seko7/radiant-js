      ...
      <Container className="relative">
        ...
        <div className="flex flex-row pb-24 pt-16 sm:pb-32 sm:pt-24 md:pb-48 md:pt-32">
          <div className="relative z-10">
            <h1 className="font-display text-balance text-6xl/[0.9] font-medium tracking-tight text-gray-950 sm:text-8xl/[0.8] md:text-2xl/[0.8]">
              Akıllı Tarım 
            </h1>
            <p className="mt-8 max-w-lg text-xl/7 font-medium text-gray-950/75 sm:text-2xl/8">
              Akıllı tarım teknolojileri ile <br/>tarlanızın kontrolü elinizde.
            </p>
