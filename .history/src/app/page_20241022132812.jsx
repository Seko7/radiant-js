  ...
  return (
    <div className="relative">
      ...
      <Container className="relative">
        ...
        <div className="flex flex-row pb-24 pt-16 sm:pb-32 sm:pt-24 md:pb-20 md:pt-32">
          <div className="relative z-10">
            ...
            <p className="mt-8 max-w-lg text-xl/7 font-medium text-gray-950/75 sm:text-2xl/8">
              Akıllı tarım teknolojileri ile tarlanızın<br/> kontrolü elinizde.
            </p>
      ...
      <img
        ...
        className=" absolute -z-10   -ml-20 sm:inset-20 sm:h-auto sm:w-[130vw] sm:rounded-none"
      ></img>
    </div>
  )
}
