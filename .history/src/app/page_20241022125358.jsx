  ...
  return (
    <div className="relative">
      ...
      <Container className="relative">
        ...
        <div className="pb-24 pt-16 sm:pb-32 sm:pt-24 md:pb-48 md:pt-32 flex flex-row relative z-10">
          <div>
          ...
          <img src='/screenshots/SuyabakanAileExtended.png' className='fixed z-0' >
          </img>
      ...
      <Container>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
          <BentoCard
            ...
            graphic={
              <div className="h-80 bg-[url(/screenshots/toprak.png)] bg-contain m-10 bg-no-repeat" />
            }
fade={['top',]}
