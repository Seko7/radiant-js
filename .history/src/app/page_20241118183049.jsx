  ...
  return (
    <div className="relative">
      ...
      <Container className="relative">
        ...
        <div className=" relative flex flex-row pb-24 pt-4 sm:pb-32 sm:pt-24 md:pb-96 md:pt-28">
          <div className="relative z-10 w-full">
            ...
            <div className="lg:mt-12 max-sm:mt-8 mb-28 lg:mb-0 flex flex-col gap-x-6 gap-y-4 sm:flex-row ">
              <Button href="#2">Başlayalım</Button>
              <Button variant="secondary" href="/cozumler" >
                Çözümlere göz at
              </Button>
            </div>
          </div>
          <img
            ...
            className="absolute lg:top-[-1rem] -z-10 lg:-ml-[7rem] -bottom-40 -ml-56 max-w-[180%] lg:max-w-[118%] rounded-4xl"
          />
        </div>
      </Container>
    </div>
...
function BentoSection() {
  return (
    <Container >
      <Subheading id='2'>Sensör Verileri</Subheading>
      <Heading as="h3" className="mt-2 max-w-3xl" >
        Tarlanızı uçtan uca kontrol eden bir sistem.
      </Heading>

      <div  className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2 md:grid-rows-2 md:grid-cols-2">
        <BentoCard
          eyebrow="Analiz"
        ...
        <BentoCard
          ...
          graphic={
            <div className="mx-20 h-80 bg-[url(/screenshots/meteoroloji.png)] bg-contain bg-[right_30px_top_0px] bg-no-repeat" />
          }
      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                ...
                <button
                  ...
                  type="button"
                  className="mt-4 w-full rounded-md bg-indigo-600 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Keşfet
                </button>
              </div>
              ...
              <div className="relative min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                <div className="absolute inset-x-9 top-20">
                  <img
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                  Sensör ve çiftlik verilerinizin güvenle ve uzun süreli
          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="min-h-96 relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-52 sm:px-10 sm:pb-0 sm:pt-10">
                <p className="mt-2 text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">
                  Çözümler
                </p>
                <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                  Mevcut sisteminize göre ve ihtiyacınıza uygun bir çok çözüm
                  sunuyoruz.
                </p>
                <button
                  onClick={() => window.location.href = "/cozumler"}
              ...
              <div className="absolute inset-x-0  lg:bottom-20 md:bottom-0 md:left-1/4 lg:left-0 sm:bottom-0 sm:left-1/4 bottom-32   ">
                  <img
                    className=" h-[20rem]  object-cover object-bottom relative -right-10"
                    src="/screenshots/farm.png"
                    alt=""
                  />
                </div>
            </div>
    ...
    <div className="overflow-hidden">
      <Navbar
          banner={
            <Link
              href="/cozumler"
              className="ml-4 flex items-center gap-1 rounded-full bg-fuchsia-950/35 px-3 py-0.5 text-sm/6 font-medium text-white data-[hover]:bg-fuchsia-950/30"
            >
              Suyabakan sayesinde tarım alanınları nasıl akıllanır
      ...
      <Hero />
      <main>
        <Container className="lg:mt-0 mt-28">
          <LogoCloud />
        </Container>
        <div className="bg-gradient-to-b from-white from-50% to-gray-100 lg:py-32 py-20">
          {/* <FeatureSection /> */}
          <BentoSection />
        </div>
        <DarkBentoSection />
