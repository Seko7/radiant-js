...
const tiers = [
  ...
  },
  {
    ...
    slug: 'enterprise',
    description: 'Uçtan uca sulama kontrolü için.',
  ...
  },
  {
    ...
    slug: 'enterprise',
    description: 'Tüm cihazları birleştir, çiftliğini akıllandır.',
...
function Header() {
  return (
    <Container className="mt-16 max-sm:mt-8">
      <Heading as="h1">Modern tarımına yönelik çözümlerimiz.</Heading>
      <Lead className="mt-6 max-w-3xl max-sm:hidden">
        Tarım alanınıza ve ihtiyacınıza göre en uygun çözümü seçin ve hemen başlayın.
      </Lead>
    </Container>
  )
}
