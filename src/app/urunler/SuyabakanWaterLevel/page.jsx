  ...
  return (
    <div className="relative isolate overflow-hidden  px-6 py-24 max-lg:py-12  lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-ml-12 -mt-12 max-sm:-mt-12 max-sm:p-5 p-12 lg:sticky lg:top-16 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            alt=""
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <p className="mt-6">
              Tarımınızı bir üst seviyeye taşıyın. Akıllı tarıma adım atın ve arazinizdeki her bir detayın kontrolünü elinize alın. Su miktarınızı takip etmenin farkını yaşayın.
              </p>
            </div>
          </div>
        </div>
            ...
            <figure className="mx-auto flex max-w-xl flex-col gap-16 max-lg:text-center">
              <blockquote>
                <p className="relative text-3xl tracking-tight text-white before:absolute before:-translate-x-full before:content-['“'] after:absolute after:content-['”'] lg:text-4xl">
                  Suyabakan Water Level ile depo su seviyesini anlık olarak takip edebiliyoruz. Bu sayede sulama işlemlerimizi daha verimli ve etkili bir şekilde yönetebiliyoruz.
                </p>
              </blockquote>
      ...
      <section id="faqs" className="scroll-mt-8">
        ...
        <div className="mx-auto mb-32 mt-16 max-w-xl space-y-12">
          <dl>
            ...
            Suyabakan Water Level nasıl çalışır?
            </dt>
            <dd className="text/6 mt-4 text-gray-600">
            Suyabakan Water Level, depo içindeki suya temas eden kablo kısmını hesaplar ve bu verileri Base Station Solar’a göndererek size anlık bilgi sağlar.
            </dd>
          </dl>
          <dl>
            <dt className="text font-semibold">
            Cihazın kurulumu kolay mı?
            </dt>
            <dd className="text/6 mt-4 text-gray-600">
            Evet, cihazın kurulumu oldukça basittir. Depoya uygun bir şekilde yerleştirilip etkinleştirildiğinde çalışmaya başlar.
            </dd>
          </dl>
          <dl>
            <dt className="text font-semibold">
            Su seviyesi bilgilerini ne kadar sıklıkla güncelliyor?
            </dt>
            <dd className="text/6 mt-4 text-gray-600">
            Cihaz, su seviyesi verilerini saatte bir günceller. Bu sıklık, kullanıcı ihtiyaçlarına göre ayarlanabilir.
            </dd>
          </dl>
          <dl>
            <dt className="text font-semibold">
            Suyabakan Water Level’ın pil ömrü ne kadar sürer?
            </dt>
            <dd className="text/6 mt-4 text-gray-600">
            Cihazın pili, enerji verimliliği sayesinde bir sezon boyunca kullanılabilir. Pil değişimi kolay ve hızlıdır.
            </dd>
          </dl>
          <dl>
            <dt className="text font-semibold">
            Hangi tür depolarla uyumludur?
            </dt>
            <dd className="text/6 mt-4 text-gray-600">
            Suyabakan Water Level, yer üstü ve yer altı su depolarıyla uyumlu olarak çalışır. Farklı depo tiplerine göre montaj seçenekleri sunar.
            </dd>
          </dl>
          <dl>
            <dt className="text font-semibold">
            Cihazın bakım gereksinimi var mı?
            </dt>
            <dd className="text/6 mt-4 text-gray-600">
            Hayır, Suyabakan Water Level, zorlu koşullara dayanacak şekilde tasarlanmıştır ve minimum bakım gerektirir. Yalnızca sensörlerin temiz tutulması yeterlidir.
            </dd>
          </dl>
          <dl>
            <dt className="text font-semibold">
            Su seviyesindeki ani değişiklikler tespit edilebilir mi?
            </dt>
            <dd className="text/6 mt-4 text-gray-600">
            Evet, cihaz su seviyesindeki ani düşüş veya artışları tespit eder ve bu durumlarla ilgili anında bilgilendirme yapar.
            </dd>
          </dl>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-balance sm:text-5xl">
            Bakım gerektirmeyen su seviyesi takibi.
          </p>
          <p className="mt-6 text-lg/8 text-gray-600">
            Depo yüksekliğine göre belirlenen Suyabakan Water Level deponuzun su seviyesini mekanik parça içermeden anlık olarak takip eder.
          </p>
        </div>
      </div>
      <div className="relative overflow-hidden pt-16">
        <div className=" relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="absolute inset-0 bg-gradient-to-b from-gray-50  to-15% group-data-[dark]:from-gray-800 group-data-[dark]:from-[-25%]" />
        <div className="absolute inset-0 bg-gradient-to-t from-gray-50  to-5% group-data-[dark]:from-gray-800 group-data-[dark]:from-[-25%]" />
          <img
            alt="App screenshot"
            src="/screenshots/soilsenseparts.png"
            width={662}
            height={2042}
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">
                  Deponun su seviyesini takip et.
                </p>
          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="relative max-lg:h-[37rem] flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              <div className="z-10 px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">
                  Depo doluluk tespiti.
                </p>
                <p className="/6 mt-2 max-w-lg text-gray-600 max-lg:text-center">
                Su depolarınızdaki doluluk oranını anlık olarak ölçerek sulama planlamalarınızı kontrollü bir şekilde yapmanıza olanak tanır.
                </p>
              </div>
              <div className="absolute inset-x-0 -bottom-5 -z-0 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-white to-10% group-data-[dark]:from-gray-800 group-data-[dark]:from-[-25%]" />
                <img
                  className="h-auto w-full md:w-8/12 sm:md:w-8/12 lg:w-full object-cover object-top"
