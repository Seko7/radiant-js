...
function Product() {
  return (
    <div className="relative isolate overflow-hidden px-6 py-24 sm:py-12 max-sm:py-12 md:py-12 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-ml-12 -mt-8 max-sm:-mt-12 max-sm:-ml-4 max-sm:p-5 p-12 lg:sticky lg:top-10 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img
            alt=""
            src="/screenshots/izcifull.png"
            className="mx-auto w-[4rem] max-w-none rounded-xl sm:w-[5.5rem]"
          />
        </div>
